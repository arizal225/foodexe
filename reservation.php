...
if (!isset($_SESSION['isLoggedIn'])) {
  ...
  echo '<script>
                    swal({
                        title: "Perhatian !",
                        text: "Anda harus Log-in ke akun anda",
                        icon: "warning",
                        button: "ok",
                    }).then(function() {
    ...
    <div class="container">
      <div class="row no-gutters justify-content-center mb-2 pb-2">
        <div class="col-md-7 text-center heading-section ftco-animate">
          <div class="header-h  mt-4">Booking.</div>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 mt-3">
                <div class="form-group text-center">
                  ...
                  <input type="submit" name="reservation" value="Pesan" class="btn btn-sm" style="background-color: #ffba3b !important; color: white;">
                </div>
              </div>
            </div>
          </form>
