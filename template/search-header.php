					...
					<form action="restaurant-list.php" method="POST" class="form-inline justify-content-center form-header">
						<div class="form-group mb-2">
							...
							<select name="city" class="custom-select mr-sm-2">
								<option value="Montpellier" required="">Jogja</option>
								<option value="Nimes" disabled>Semarang (Soon)</option>
							</select>
						</div>
						<div class="form-group mb-2">
						...
						<input type="submit" class="btn btn-outline-warning mb-2 btn-header" name="find" value="Cari" style="margin-left: 20px;">
					</form>
					<!--  -->
				</div>
			</div>
