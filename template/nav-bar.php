...
<nav class="fixed-top navbar navbar-expand-lg navbar-light ftco_navbar bg-light ftco-navbar-light" id="ftco-navbar">
	...
	<div class="collapse navbar-collapse" id="ftco-nav">
		...
		<ul class="ul">
			<li class="ul">
				<div class="logo-holder logo-5">
					<a href="accueil.php">
						<h3>Panganan</h3>
						<p class="p" style="font-style: normal; font-weight: 100; font-family:'Helvetica, sans-serif"></p>
					</a>
				</div>
			</li>
		</ul>
		...
		<ul class="navbar-nav ml-auto">
			<li class="nav-item active"><a href="accueil.php" class="nav-link">Beranda</a></li>
			<?php if (!isset($_SESSION['isLoggedIn'])) { ?>
				<li class="nav-item"><a href="register.php" class="nav-link">Daftar Akun</a></li>
			...
			<?php } elseif (isset($_SESSION['isLoggedIn'])) { ?>
				<li class="nav-item dropdown">
					<a style="color: #ffb03b !important;" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						Halo <span style="text-transform: capitalize;"><?php echo $_SESSION['name']; ?> <?php echo $_SESSION['first_name']; ?></span>
					</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="profil-user.php" class="nav-link"><i class="far fa-user-circle"></i> Profile Saya</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="logout.php" class="nav-link"><i class="fas fa-sign-out-alt"></i> Keluar</a>
					</div>
				</li>
			<?php } ?>
		</ul>
