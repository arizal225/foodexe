...
<aside id="sidebar-left" class="sidebar-left">
							...
							<ul class="nav nav-children">
								<li>
									<a href="person-table-add.php">
										<span class="pull-right label label-primary">Tambah</span>
								...
								<li>
									<a href="person-table-list.php">
										<span class="pull-right label label-info">Daftar</span>
										<i class="fas fa-list-ul" aria-hidden="true"></i>
										<span>Daftar Meja yang Tersedia</span>
									</a>
								</li>
							</ul>
						</li>
							...
							<ul class="nav nav-children">
								...
								<li>
									<a href="menu-list.php">
										...
										<i class="fas fa-list-ul" aria-hidden="true"></i>
										<span>Hidangan yang Tersedia</span>
									</a>
								</li>
							</ul>
						</li>
	...
	<div class="logo-bookeat" id="logo-bookeat">
		<span class="text-1">Panganan.</span>
		<span class="text-2">© 2023</span>
	</div>
</aside>
