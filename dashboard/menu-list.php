				...
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>Daftar Hidangan</span></li>
						</ol>
				...
				<section class="panel">
					<header class="panel-heading">
						...
						<p class="panel-subtitle">
							Ini untuk mengakses <code>list menu</code>, Jika ingin menghapus menu , silahkan klik tombol <code>"Hapus"</code> .
						</p>
					</header>
					<div class="panel-body">
						<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf" data-plugin-options='{"searchPlaceholder": "Cari"}'>
							<thead>
								<tr>
									<th>N°</th>
									<th>Foto</th>
