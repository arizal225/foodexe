	...
	<section class="body">
		...
		<div class="inner-wrapper">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>Meja Restoran</span></li>
							<li><span>Daftar Kursi</span></li>
						</ol>
				...
				<!-- start: page -->
				<section class="panel">
					<a href="#exampleModal" class="btn btn-warning btn-sm" data-toggle="modal">Tambah</a>
					<br>
					<header class="panel-heading">
						...
						<h2 class="panel-title">Semua meja untuk opsi yang dipilih</h2>
						<p class="panel-subtitle">
							Untuk menambahkan <code>meja baru </code>, silakan pilih tombolnya <code>"Tambah"</code>. <br><br>
							Anda dapat menghapus tabel jika perlu.
						</p>
					</header>
