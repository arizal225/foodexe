          ...
          if ($extension == "jpg" || $extension == "png" || $extension == "jpeg") {
            ...
            if ($con->query($sql) === TRUE) {
              echo '<script>
                    swal({
                      title: "WOW !",
                      text: "Gambar Anda telah Diupdate!",
                      icon: "Sukses",
                      button: "Ok",
                    }).then(function() {
            ...
            echo '<script>
                    swal({
                      title: "Peringatan!",
                      text: "Anda Hanya bisa mengupload JPG, PNG, dan GIF!",
                      icon: "Error",
                      button: "Ok",
                    }).then(function() {
                      window.location.href ="profile.php";
          ...
          <div class="row">
            <div class="col-lg-3">
              ...
              <div class="panel panel-default">
                ...
                <ul class="list-group">
                  <li class="list-group-item text-muted" style="text-align: center;">Profil Restoran</li>
                  <li class="list-group-item text-right"><span class="pull-left"><strong>Restoran</strong></span>
                    <?php echo '<div style="text-transform: capitalize;">' . $row['rc_name'] . '</div>'; ?>
                  </li>

                  </li>
                  <li class="list-group-item text-right"><span class="pull-left"><strong>Buka / Tutup</strong></span>
                    <?php
                    $id = $_SESSION['id'];
                    $con = connect();
                    ...
                    foreach ($result as $r) {
                    ?>
                      <div class="text-right" style="color: rgb(63, 153, 63); font-weight: 600;" class="opening">Buka :<?php echo date('H:i', strtotime($r['opening_res'])); ?> WIB</div>
                    <?php
                    }
                    ?>
                    <?php
                    ...
                    foreach ($result as $r) {
                    ?>
                      <div style="color: rgb(63, 153, 63); font-weight: 600;" class="opening">Tutup : <?php echo date('H:i', strtotime($r['closing_res'])); ?> WIB</div>
                    <?php
                    }
                    ?>
                  </li>
              ...
              <form class="form-horizontal" method="POST" action="profile.php">
                <div class="row">
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="Fname">Nama Restoran :</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="Lname">Lokasi :</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="Mname">No Telepon :</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="CustomerAddress">Kategori :</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="Gender">Alamat lengkap :</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="CustomerContact">Jam :</label>
                      <div class="col-md-4">
                        <?php
                        if (isset($_POST['save'])) {
                          $id = $_SESSION['id'];
                        ...
                        ?>
                        <label for="opening_res">Buka :</label>
                        <?php
                        $id = $_SESSION['id'];
                        $con = connect();
                        $sql = "SELECT `opening_res` FROM `rc_info` WHERE id = $id;";
                      ...
                      <div class="col-md-4">
                        ...
                        ?>
                        <label for="closing_res">Tutup :</label>
                        <?php
                        $id = $_SESSION['id'];
                        $con = connect();
                        $sql = "SELECT `closing_res` FROM `rc_info` WHERE id = $id;";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Gambar atau Logo.</h4>
      </div>
      <form action="profile.php" enctype="multipart/form-data" method="post">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary" name="savephoto" type="submit">Kirim Gambar</button>
        </div>
      </form>
    </div><!-- /.modal-content-->
  </div><!-- /.modal-dialog -->
