...
<body>
	...
	<section class="body-sign">
		<div class="circle-login">Panganan. </div>
		<div class="center-sign">
			<div class="panel panel-sign">
				<div class="panel-title-sign text-right" style="margin-top: 5em !important;">
					<h2 class="title text-uppercase text-bold m-none"><i class="fa fa-user mr-xs"></i> Koneksi</h2>
				</div>
				<div class="panel-body">
					<form action="" method="POST">
						...
						<div class="mb-xs text-center">
							<a class="btn btn-facebook mb-md ml-xs mr-xs">Hubungkan dengan <i class="fa fa-facebook"></i></a>
							<a class="btn btn-twitter mb-md ml-xs mr-xs">Hubungkan dengan <i class="fa fa-twitter"></i></a>
						</div>
						<p class="text-center">Belum punya akun? <a href="pages-signup.html">Daftar!</a>
					</form>
				</div>
			</div>
