						...
						<div class="invoice">
							<header class="clearfix">
								<div class="row">
									<div class="col-sm-4 mt-md">
										<h2 class="h2 mt-none mb-sm text-dark text-bold">PEMESANAN</h2>
										<h4 style="color: orange;" class="h4 m-none text-bold">
											No #<?php echo $_GET['booking-number']; ?></h4>
									</div>
									<?php
									include 'dbCon.php';
									$con = connect();
									...
									?>
										<div class="col-sm-8 text-right mt-md mb-md">
											<address class="ib mr-xlg">
												...
												<br />
												<!-- FOR FRANCE -->
												Nomor Telepon : +62<?php echo $r['phone']; ?>
												<br />
												<?php echo $r['email']; ?>
											</address>
											<div class="ib">
							...
							<div class="bill-info">
								<div class="row">
									<div class="col-md-6">
										<div class="bill-to">
											<p class="h4 mb-xs text-dark text-semibold">Informasi Kustomer :</p>
											<address>
												<?php echo "Last Name & First Name : " . $booking_name; ?>
												<?php echo $booking_first_name; ?>
												<br />
												<!-- French number phone -->
												Nomor Telepon : +62 <?php echo $booking_phone; ?>
											</address>
										</div>
									</div>
									<div class="col-md-6">
										<div class="bill-data text-right">
											<p class="h4 mb-xs text-dark text-semibold">Informasi Pemesanan Tanggal & Jam :</p>
											<p class="mb-none">
												<span class="text-dark">Tanggal Pemesanan : </span>
												<span class="value"><?php echo date("d/m/Y", strtotime($booking_date)); ?></span>
											</p>
											<p class="mb-none">
												<span class="text-dark">Jam Pemesanan : </span>
							...
							<div class="bill-info">
								<div class="row">
									<div class="col-md-6">
										<div class="bill-to">
											<p class="h4 mb-xs text-dark text-semibold">Berapa orang & nomor meja:</p>
											<address id="table">
												<?php
												$booking_number = $_GET['booking-number'];
