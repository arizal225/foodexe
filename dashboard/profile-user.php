        ...
        if (isset($_POST['save'])) {
          ...
          if ($sql->affected_rows > 0) {
            ...
            echo '<script>
                    swal({
                      title: "Mantap !",
                      text: "Profil andatelah diupdate!",
                      icon: "Sukses ",
                      button: "ok",
                    }).then(function() {
              ...
              <form class="form-horizontal" method="POST" action="profile.php">
                <div class="row">
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="Fname">Nama Restaurant :</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      ...
                      <div class="col-md-4">
                        ...
                        ?>
                        <label for="opening_res">Pembukaan :</label>
                        <?php
                        $id = $_SESSION['id'];
                        $con = connect();
                        $sql = "SELECT `opening_res` FROM `rc_info` WHERE id = $id;";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Gambar or/ Logo.</h4>
      </div>
